...
# Especificar o modelo LDA

```{r}
# Especificando o modelo LDA
lda_spec <- discrim_linear(
  penalty = tune(),
  regularization_method = "shrink_cov"
) |> 
  set_engine("MASS") |> 
...
```{r}
final_lda <- finalize_workflow(lda_workflow, best_params)
```

# Treinar o modelo final nos dados de treino completos

```{r}
final_fit <- fit(final_lda, data = train_data)
```
