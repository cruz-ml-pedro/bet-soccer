---
title: "Suporte Vector Machine Model"
format: html
editor: visual
---
...
```{r}
pacman::p_load(tidyverse, tidymodels, vip, here, xgboost, themis, colino)
...
data_split <- initial_split(dados_novo, prop = 0.6, strata = Res)
...
```{r}
final_fit <- fit(final_svm, data = train_data)
```
